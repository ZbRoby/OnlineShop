...
public class AddressRepositoryTest {
    ...
    public void findAllByCityTest() {
        ...
        repository.findAllByCity(city1).stream().forEach(repository::delete);
        repository.findAllByCity(city2).stream().forEach(repository::delete);
        repository.findAllByCity("CityOther5").stream().forEach(repository::delete);
        repository.findAllByCity("CityOther6").stream().forEach(repository::delete);
    ...
    public void findAllByCountryTest() {
        ...
        repository.findAllByCountry(country1).stream().forEach(repository::delete);
        repository.findAllByCountry(country2).stream().forEach(repository::delete);
        repository.findAllByCountry("CountryOther1").stream().forEach(repository::delete);
        repository.findAllByCountry("CountryOther2").stream().forEach(repository::delete);
    ...
    public void findAllByStreetTest() {
        ...
        repository.findAllByStreet(street1).stream().forEach(repository::delete);
        repository.findAllByStreet(street2).stream().forEach(repository::delete);
        repository.findAllByStreet("StreetOther1").stream().forEach(repository::delete);
        repository.findAllByStreet("StreetOther2").stream().forEach(repository::delete);
    ...
    public void findAllByZipCodeTest() {
        ...
        repository.findAllByZipCode(zipCode1).stream().forEach(repository::delete);
        repository.findAllByZipCode(zipCode2).stream().forEach(repository::delete);
        repository.findAllByZipCode("ZipCodeOther1").stream().forEach(repository::delete);
        repository.findAllByZipCode("ZipCodeOther2").stream().forEach(repository::delete);

...
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 1, 0.0, 18, 788.58,  9, 11, 19);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 2, 0.0,  7,  97.25,  1,  9,  7);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 3, 0.0,  9, 347.03, 19, 15,  3);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 4, 0.0, 20, 347.03,  7, 15,  3);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 5, 0.0,  9, 870.84, 16, 16,  4);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 6, 0.0,  5, 408.88, 17,  1,  6);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 7, 0.0, 20, 566.36, 12, 20,  8);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 8, 0.0, 12, 777.74, 19,  4,  1);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values ( 9, 0.0, 15, 408.88, 20,  2,  8);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (10, 0.0, 20, 241.89,  8,  6,  1);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (11, 0.0,  9, 959.09,  5, 14,  3);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (12, 0.0,  7,  97.25, 15,  9,  7);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (13, 0.0, 18, 994.01,  2,  8, 19);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (14, 0.0,  2, 408.88, 16,  1,  6);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (15, 0.0, 15, 777.74, 20,  4,  1);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (16, 0.0,  9,   9.91, 20, 19, 10);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (17, 0.0, 13, 408.88,  8,  1,  6);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (18, 0.0,  8, 408.88,  9,  2,  8);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (19, 0.0,  6, 616.51, 19,  7,  3);
insert into ORDER_DETAILS (ID, DISCOUNT, QUANTITY, UNIT_PRICE, ORDER_ID, PRODUCT_ID, LOCATION_ID) values (20, 0.0, 13, 283.24, 12,  3,  3);
...
insert into PRODUCTS_LOCATIONS (PRODUCT_ID, LOCATION_ID, QUANTITY) values (11, 19, 0);
insert into PRODUCTS_LOCATIONS (PRODUCT_ID, LOCATION_ID, QUANTITY) values (16, 4, 0);
insert into PRODUCTS_LOCATIONS (PRODUCT_ID, LOCATION_ID, QUANTITY) values (20, 8, 0);
insert into PRODUCTS_LOCATIONS (PRODUCT_ID, LOCATION_ID, QUANTITY) values (14, 3, 0);
insert into PRODUCTS_LOCATIONS (PRODUCT_ID, LOCATION_ID, QUANTITY) values (3, 3, 0);
